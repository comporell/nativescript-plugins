import { AfterContentInit, ChangeDetectionStrategy, Component, ContentChild, Directive, DoCheck, ElementRef, EmbeddedViewRef, EventEmitter, forwardRef, Host, Inject, InjectionToken, Input, IterableDiffer, IterableDiffers, NgModule, NO_ERRORS_SCHEMA, OnDestroy, Output, TemplateRef, ViewChild, ViewContainerRef, ɵisListLikeIterable as isListLikeIterable } from '@angular/core';
...
import { Accordion } from '@comporell/nativescript-accordion';
