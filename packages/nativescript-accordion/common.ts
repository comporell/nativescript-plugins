import { CoercibleProperty, CssProperty, CSSType, KeyedTemplate, Length, Property, Style, Template, View, ContainerView, Observable, ChangedData, ObservableArray, addWeakEventListener, removeWeakEventListener, Label, Builder, CoreTypes } from '@nativescript/core';
...
export abstract class AccordionBase extends ContainerView {
  ...
  public static knownFunctions = ['itemHeaderTemplateSelector', 'itemContentTemplateSelector', 'headerTemplateSelector', 'footerTemplateSelector', 'itemIdGenerator', 'childIdGenerator'];
