import { KeyedTemplate, Length, View, Color, profile, fromObject, Observable, ProxyViewContainer, StackLayout, Utils, CoreTypes } from '@nativescript/core';
import { AccordionBase, footerTemplatesProperty, headerTemplatesProperty, iosEstimatedFooterRowHeightProperty, iosEstimatedHeaderRowHeightProperty, iosEstimatedItemContentRowHeightProperty, iosEstimatedItemHeaderRowHeightProperty, itemContentTemplatesProperty, itemHeaderTemplatesProperty, selectedIndexesProperty } from './common';
...
export class Accordion extends AccordionBase {
  ...
  public scrollToIndex(index: number) {
    if (this.ios) {
      this.ios.scrollToRowAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UITableViewScrollPosition.Top, false);
    }
  }
